...
//new
$sql = "SELECT COUNT(*) as count FROM post WHERE Post_Status = 'Post Assign'";
...
//answered
$sql = "SELECT COUNT(*) as count FROM post WHERE Post_Status = 'Post Answered'";
$stmt = $conn->prepare($sql);
$stmt->execute();
$row = $stmt->fetch(PDO::FETCH_ASSOC);
...
<body>
    ...
    <div class="contentpart">
        ...
        <div id="maincontentpage">
            <div class="p-2 mb-1 bg-primary text-white">
                <h5 class="text-uppercase fw-bolder">POST REPORT</h5>
            </div>
    ...
    <script>
        ...
        new Chart(ctx, {
            type: 'pie',
            data: {
                labels: ['New Post', 'Answered Post'],
                datasets: [{
                    label: 'Total',
                    data: [<?php echo $assigncount ?>, <?php echo $answeredcount ?>],
                    borderWidth: 1
                }]
            },
            options: {
